...
import za.ac.cput.Cricket.factory.Facilitiesfactory;
import za.ac.cput.Cricket.repos.impl.FacilityRepoImp;
...
public class FacilityServiceImpTest {
    ...
    public void update() {
        ...
        Assert.assertEquals(newChechId,updated.hotelId());
        d_getAll();
    }

    @Test
    public void delete() {
        this.repository.delete(facilities.hotelId());
        d_getAll();
    }

    @Test
    public void read() {
        Facilities read = this.repository.read(facilities.hotelId());
